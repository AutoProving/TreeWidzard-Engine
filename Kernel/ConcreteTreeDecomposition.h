...
class ConcreteTreeDecomposition {
  public:
	...
	bool readAbstractVertexNumber(string::iterator &it,
								  unsigned &v); // This function will be deleted
	bool readAbstractEdgeNumber(
		string::iterator &it,
		pair<unsigned, unsigned> &e); // This function will be deleted
	shared_ptr<CTDNodeNew> readAbstractExpressionRecursive(
		string::iterator &it, string::iterator end,
		vector<shared_ptr<CTDNodeNew>>
