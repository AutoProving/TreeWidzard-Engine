...
IsomorphismBreadthFirstSearch* create_parameter(DynamicKernel* dynamicKernel,
...
void IsomorphismBreadthFirstSearch::search() {
  ...
  while (!newStatesSet.empty()) {
    ...
    set_union(allStatesSet.begin(), allStatesSet.end(), newStatesSet.begin(),
              newStatesSet.end(), inserter(setUnion, setUnion.begin()));
