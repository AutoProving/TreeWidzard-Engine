if __name__ == '__main__':
    ...
    tableDescriptions = { "max-rss": "Memory in Kilo Bytes used by", "all-states" : "States generated by" ,"elapsed": "Time in seconds used by","max-witness-size": "Maximum Witness Size generated by"}
    searchFlag = [" ", "-premise"]
    e = [] # (<directory of csv>,[searches],<property_name>,[widths],[width_range],[property_range],[flags])
    e1 = ["reed-conjecture-pw/csv-reed-pw-iso.csv",["IsomorphismBreadthFirstSearch"],"MaxDegree",[" pw = "],[1,2,3,4,5],[2,3,4,5,6],searchFlag,"Reed's Conjecture.","The numbers are for witness size of Chromatic Number, Maximum Degree, Clique Number, and Has Multiple Edges, respectively."]
    e.append(e1)
  ...
  #  
    ...
    for item in e:
        ...
        for comparing_key in comparing_keys:
            ...
            table_file.write("\caption{"+ item[7] + " " + tableDescriptions[comparing_key] + " " + searchDescriptions[searches[0]] + " and Premise "+ searchDescriptions[searches[0]] +"."+ (" "+item[8] if comparing_key == "max-witness-size" else "") + "}\n")
