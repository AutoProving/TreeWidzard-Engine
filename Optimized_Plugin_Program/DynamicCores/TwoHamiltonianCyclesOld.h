...
class TwoHamiltonianCycles_Witness: public WitnessBase, public enable_shared_from_this<TwoHamiltonianCycles_Witness>{
public:
    ...
    WitnessBase& set_equal_implementation(TwoHamiltonianCycles_WitnessPointerConst w);
