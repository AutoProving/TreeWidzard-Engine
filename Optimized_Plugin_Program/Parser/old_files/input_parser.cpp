...
{
       0,    63,    63,    65,    67,    68,    70,    75,    78,    81,
      86,    87,    88,    90,    92,    93,    94,    95,    96,    98,
      99,   100,   101,   103,   104,   106,   107
};
#endif
...
{
  "$end", "error", "$undefined", "WIDTHPARAM", "SEPERATOR", "COMPARATOR",
  "FILEPATH", "LEFTP", "RIGHTP", "NAME", "NEWLINE", "AND", "OR", "IFF",
  "IMPLIES", "NOT", "TRUE", "FALSE", "COMMENT", "INTEGER", "COMMA",
  "$accept", "START", "WIDTH_ASSIGNMENT", "VARIABLES_ASSIGNMENT",
  "VARIABLE_ASSIGNMENT", "INTEGERS", "ATOMIC_PREDICATE", "VARIABLE",
  "FORMULA", "COMMENTS", "FORMULACOMMENTS", YY_NULLPTR
};
#endif
...
{
      -8,    -8,    20,    22,   -12,   -12,     7,    17,   -12,    -8,
     -12,    14,    14,   -12,    14,   -12,   -12,    18,    30,    29,
     -12,    24,   -12,    -8,    35,    -8,    14,    14,    14,    14,
     -12,   -12,   -12,   -12,     4,    23,   -12,    34,    -7,     1,
      27,     0,   -12,   -12,    39,   -12,    -6,   -12,   -12,    31,
     -12
};
...
{
      24,    24,     0,     0,    23,     1,     0,     0,     3,    24,
       5,     0,     0,    13,     0,    20,    21,     0,    22,    26,
      22,     0,    14,    24,     0,    24,     0,     0,     0,     0,
       2,    19,     4,    12,     8,    26,    15,    16,    18,    17,
       0,     0,    25,     6,     0,    11,     0,     7,     9,     0,
      10
};
...
{
       4,    21,    48,    22,    26,    27,    44,    29,    10,    40,
       1,    41,    26,    27,    49,    36,    37,    38,    39,    45,
       5,    12,    32,    13,    35,     6,     8,     9,    23,    14,
      15,    16,    31,    25,    24,    26,    27,    28,    29,    25,
      26,    27,    28,    29,    33,    26,    43,    47,    18,     0,
      50,    42
};

static const yytype_int8 yycheck[] =
{
       1,    12,     8,    14,    11,    12,     6,    14,     9,     5,
      18,     7,    11,    12,    20,    26,    27,    28,    29,    19,
       0,     7,    23,     9,    25,     3,    19,    10,    10,    15,
      16,    17,     8,    10,     4,    11,    12,    13,    14,    10,
      11,    12,    13,    14,     9,    11,    19,     8,    11,    -1,
      19,    35
};
...
{
       0,    18,    22,    30,    30,     0,     3,    23,    19,    10,
      30,    24,     7,     9,    15,    16,    17,    25,    28,    29,
      28,    29,    29,    10,     4,    10,    11,    12,    13,    14,
      31,     8,    30,     9,    27,    30,    29,    29,    29,    29,
       5,     7,    31,    19,     6,    19,    26,     8,     8,    20,
      19
};
...
{
       0,    21,    22,    23,    24,    24,    25,    25,    25,    25,
      26,    26,    27,    28,    29,    29,    29,    29,    29,    29,
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == YYEMPTY)                                        \
      ...
      {                                                           \
        yyerror (pl, conj, w, result, YY_("syntax error: cannot back up")); \
        YYERROR;                                                  \
      }                                                           \
  while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Type, Value, Location, pl, conj, w, result); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::vector<PropertyAssignment*> &pl, Conjecture &conj, Width &w, int &result)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::vector<PropertyAssignment*> &pl, Conjecture &conj, Width &w, int &result)
{
  YYFPRINTF (yyo, "%s %s (",
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yytype, yyvaluep, yylocationp, pl, conj, w, result);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, std::vector<PropertyAssignment*> &pl, Conjecture &conj, Width &w, int &result)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)]
                       , &(yylsp[(yyi + 1) - (yynrhs)])                       , pl, conj, w, result);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, yylsp, Rule, pl, conj, w, result); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, std::vector<PropertyAssignment*> &pl, Conjecture &conj, Width &w, int &result)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (pl);
...
int
yyparse (std::vector<PropertyAssignment*> &pl, Conjecture &conj, Width &w, int &result)
{
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 63 "input_parser.y"
                                                                                                                        { conj.root = (yyvsp[-1].conjecture); result = 0; }
#line 1522 "input_parser.cpp"
    break;

  case 3:
#line 65 "input_parser.y"
                                                                                                                        {w.set_name((yyvsp[-1].string)); w.set_value((yyvsp[0].number)); }
#line 1528 "input_parser.cpp"
    break;

  case 4:
#line 67 "input_parser.y"
                                                                                                                        {}
#line 1534 "input_parser.cpp"
    break;

  case 6:
#line 70 "input_parser.y"
...
#line 1543 "input_parser.cpp"
    break;

  case 7:
#line 75 "input_parser.y"
...
#line 1551 "input_parser.cpp"
    break;

  case 8:
#line 78 "input_parser.y"
...
#line 1559 "input_parser.cpp"
    break;

  case 9:
#line 81 "input_parser.y"
                                                                                                                        {if(!check_variables((yyvsp[-5].string))) exit(20);
														  	(yyval.property) = new PropertyAssignment(); (yyval.property)->set_type("MultiParameter"); (yyval.property)->set_label((yyvsp[-5].string)); (yyval.property)->set_name((yyvsp[-3].string));
														  	(yyval.property)->set_parameters(*(yyvsp[-1].vec));
														  	pl.push_back((yyval.property)); variables.push_back((yyvsp[-5].string));}
#line 1568 "input_parser.cpp"
    break;

  case 10:
#line 86 "input_parser.y"
                                                 {(yyval.vec) = new std::vector<int>; (yyval.vec) = (yyvsp[-2].vec); (yyval.vec)->push_back((yyvsp[0].number));}
#line 1574 "input_parser.cpp"
    break;

  case 11:
#line 87 "input_parser.y"
                                  { (yyval.vec) = new std::vector<int>;  (yyval.vec)->push_back((yyvsp[0].number));}
#line 1580 "input_parser.cpp"
    break;

  case 14:
#line 92 "input_parser.y"
...
#line 1592 "input_parser.cpp"
    break;

  case 16:
#line 94 "input_parser.y"
                                                                    {(yyval.conjecture) = new ConjectureNode(); (yyval.conjecture)->setLogicalOperator((yyvsp[-1].string)); (yyval.conjecture)->addChild((yyvsp[-2].conjecture)); (yyval.conjecture)->addChild((yyvsp[0].conjecture));}
#line 1598 "input_parser.cpp"
    break;

  case 17:
#line 95 "input_parser.y"
                                                                    {(yyval.conjecture) = new ConjectureNode(); (yyval.conjecture)->setLogicalOperator((yyvsp[-1].string)); (yyval.conjecture)->addChild((yyvsp[-2].conjecture)); (yyval.conjecture)->addChild((yyvsp[0].conjecture));}
#line 1604 "input_parser.cpp"
    break;

  case 18:
#line 96 "input_parser.y"
                                                                    {(yyval.conjecture) = new ConjectureNode(); (yyval.conjecture)->setLogicalOperator((yyvsp[-1].string)); (yyval.conjecture)->addChild((yyvsp[-2].conjecture)); (yyval.conjecture)->addChild((yyvsp[0].conjecture));}
#line 1610 "input_parser.cpp"
    break;

  case 19:
#line 98 "input_parser.y"
                                                                    {(yyval.conjecture) = (yyvsp[-1].conjecture);}
#line 1616 "input_parser.cpp"
    break;

  case 20:
#line 99 "input_parser.y"
...
#line 1622 "input_parser.cpp"
    break;

  case 21:
#line 100 "input_parser.y"
                                                                    {(yyval.conjecture) = new ConjectureNode(); (yyval.conjecture)->setLogicalOperator((yyvsp[0].string)); (yyval.conjecture)->setPropertyIndex(0); }
#line 1628 "input_parser.cpp"
    break;

  case 22:
#line 101 "input_parser.y"
...
#line 1634 "input_parser.cpp"
  ...
  case 23:
#line 103 "input_parser.y"
                                                                    {}
#line 1640 "input_parser.cpp"
    break;
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (pl, conj, w, result, YY_("syntax error"));
#else
# define YYSYNTAX_ERROR yysyntax_error (&yymsg_alloc, &yymsg, \
                                        yyssp, yytoken)
      {
        ...
        yyerror (pl, conj, w, result, yymsgp);
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, &yylloc, pl, conj, w, result);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, yylsp, pl, conj, w, result);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (pl, conj, w, result, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[+*yyssp], yyvsp, yylsp, pl, conj, w, result);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
