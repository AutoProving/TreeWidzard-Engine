...
extern void yyerror(std::vector<PropertyAssignment *> &pl, Conjecture &conj,
					Width &w, int &result, char const *msg);
...
int yyparse(std::vector<PropertyAssignment *> &pl, Conjecture &conj, Width &w,
			int &result);
...
static const yytype_uint8 yyrline[] = {0,  60, 60, 62, 64, 65, 67, 72,
									   76, 78, 80, 81, 82, 83, 84, 86,
									   87, 88, 89, 91, 92, 94, 95};
#endif
...
static const yytype_int8 yypact[] = {
	-12, -12, 9,  16, -13, -13, 1,   11,  -13, -12, -13, -5,  -5, -13, -5,  -13,
	-13, 27,  21, 20, -13, 15,  -13, -12, 30,  -12, -5,  -5,  -5, -5,  -13, -13,
	-13, -13, 0,  31, -13, 29,  24,  2,   23,  37,  -13, -13, 36, -13};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = {
	20, 20, 0,  0,  19, 1,  0,  0,  3, 20, 5,  0, 0, 9, 0, 16,
	17, 0,  18, 22, 18, 0,  10, 20, 0, 20, 0,  0, 0, 0, 2, 15,
	4,  8,  0,  22, 11, 12, 14, 13, 0, 0,  21, 6, 0, 7};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-13, -13, -13, -13, -13,
									  -13, 34,  -11, -1,  12};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 2, 7, 11, 17, 34, 20, 19, 3, 30};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_uint8 yytable[] = {
	4,  21, 12, 22, 13, 40, 1,  41, 10, 5,  14, 15, 16, 26, 27, 36,
	37, 38, 39, 6,  8,  9,  32, 31, 35, 24, 26, 27, 28, 29, 25, 26,
	27, 28, 29, 26, 27, 23, 29, 33, 26, 25, 43, 44, 45, 18, 0,  42};

static const yytype_int8 yycheck[] = {
	1,  12, 7,  14, 9,  5,  18, 7, 9,  0,  15, 16, 17, 11, 12, 26,
	27, 28, 29, 3,  19, 10, 23, 8, 25, 4,  11, 12, 13, 14, 10, 11,
	12, 13, 14, 11, 12, 10, 14, 9, 11, 10, 19, 6,  8,  11, -1, 35};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = {
	0,  18, 21, 28, 28, 0,  3,  22, 19, 10, 28, 23, 7,  9,  15, 16,
	17, 24, 26, 27, 26, 27, 27, 10, 4,  10, 11, 12, 13, 14, 29, 8,
	28, 9,  25, 28, 27, 27, 27, 27, 5,  7,  29, 19, 6,  8};

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = {0,  20, 21, 22, 23, 23, 24, 24,
									25, 26, 27, 27, 27, 27, 27, 27,
									27, 27, 27, 28, 28, 29, 29};

/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 7, 2, 4, 0, 5, 6, 1, 1, 2, 3,
									3, 3, 3, 3, 1, 1, 1, 2, 0, 3, 0};
...
#define YY_SYMBOL_PRINT(Title, Type, Value, Location)                   \
	do {                                                                \
		if (yydebug) {                                                  \
			...
			yy_symbol_print(stderr, Type, Value, Location, pl, conj, w, \
							result);                                    \
			YYFPRINTF(stderr, "\n");                                    \
		}                                                               \
	} while (0)
...
static void yy_symbol_value_print(FILE *yyoutput, int yytype,
								  ...
								  std::vector<PropertyAssignment *> &pl,
								  Conjecture &conj, Width &w, int &result) {
	FILE *yyo = yyoutput;
	YYUSE(yyo);
	YYUSE(yylocationp);
	YYUSE(pl);
...
static void yy_symbol_print(FILE *yyoutput, int yytype,
	...
	YYFPRINTF(yyoutput, ": ");
	yy_symbol_value_print(yyoutput, yytype, yyvaluep, yylocationp, pl, conj, w,
						  result);
	YYFPRINTF(yyoutput, ")");
}
...
static void yy_reduce_print(yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
							int yyrule, std::vector<PropertyAssignment *> &pl,
							Conjecture &conj, Width &w, int &result) {
...
static void yydestruct(const char *yymsg, int yytype, YYSTYPE *yyvaluep,
					   YYLTYPE *yylocationp,
					   std::vector<PropertyAssignment *> &pl, Conjecture &conj,
					   Width &w, int &result) {
	YYUSE(yyvaluep);
	YYUSE(yylocationp);
	YYUSE(pl);
...
#line 62 "parser.y" /* yacc.c:1646  */
		{
			w.set_name((yyvsp[-1].string));
			w.set_value((yyvsp[0].number));
		}
...
#line 67 "parser.y" /* yacc.c:1646  */
		{
			...
			(yyval.property) = new PropertyAssignment();
			(yyval.property)->set_type("numeric");
			(yyval.property)->set_label((yyvsp[-4].string));
			(yyval.property)->set_name((yyvsp[-2].string));
			(yyval.property)->set_operatorSign((yyvsp[-1].string));
			(yyval.property)->set_value((yyvsp[0].number));
			pl.push_back((yyval.property));
			variables.push_back((yyvsp[-4].string));
		}
...
#line 72 "parser.y" /* yacc.c:1646  */
		{
			...
			(yyval.property) = new PropertyAssignment();
			(yyval.property)->set_type("file");
			(yyval.property)->set_label((yyvsp[-5].string));
			(yyval.property)->set_name((yyvsp[-3].string));
			(yyval.property)->set_filePath((yyvsp[-1].string));
			pl.push_back((yyval.property));
			variables.push_back((yyvsp[-5].string));
		}
...
#line 80 "parser.y" /* yacc.c:1646  */
		{
			(yyval.conjecture) = new ConjectureNode();
			(yyval.conjecture)->setLogicalOperator((yyvsp[-1].string));
			(yyval.conjecture)->addChild((yyvsp[0].conjecture));
		}
...
#line 81 "parser.y" /* yacc.c:1646  */
		{
			(yyval.conjecture) = new ConjectureNode();
			(yyval.conjecture)->setLogicalOperator((yyvsp[-1].string));
			(yyval.conjecture)->addChild((yyvsp[-2].conjecture));
			(yyval.conjecture)->addChild((yyvsp[0].conjecture));
		}
...
#line 87 "parser.y" /* yacc.c:1646  */
		{
			(yyval.conjecture) = new ConjectureNode();
			(yyval.conjecture)->setLogicalOperator((yyvsp[0].string));
		}
...
#line 89 "parser.y" /* yacc.c:1646  */
		{
			(yyval.conjecture) = new ConjectureNode();
			(yyval.conjecture)
				->setPropertyIndex(index_variable((yyvsp[0].string)));
		}
...
#undef YYSYNTAX_ERROR
	...
	if (yyerrstatus == 3) {
		...
		if (yychar <= YYEOF) {
			...
			yydestruct("Error: discarding", yytoken, &yylval, &yylloc, pl, conj,
					   w, result);
			yychar = YYEMPTY;
		}
	}
...
yyerrlab1:
	...
	for (;;) {
		...
		yydestruct("Error: popping", yystos[yystate], yyvsp, yylsp, pl, conj, w,
				   result);
		YYPOPSTACK(1);
		yystate = *yyssp;
		YY_STACK_PRINT(yyss, yyssp);
...
yyreturn:
	...
	YY_STACK_PRINT(yyss, yyssp);
	while (yyssp != yyss) {
		yydestruct("Cleanup: popping", yystos[*yyssp], yyvsp, yylsp, pl, conj,
				   w, result);
		YYPOPSTACK(1);
	}
#ifndef yyoverflow
...
void yyerror(std::vector<PropertyAssignment *> &pl, Conjecture &conj, Width &w,
			 int &result, char const *msg) {
