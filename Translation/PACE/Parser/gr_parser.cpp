...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GR_P = 3,                       /* GR_P  */
  YYSYMBOL_GR_TW = 4,                      /* GR_TW  */
  YYSYMBOL_GR_NUM = 5,                     /* GR_NUM  */
  YYSYMBOL_GR_COMMENT = 6,                 /* GR_COMMENT  */
  YYSYMBOL_GR_NEWLINE = 7,                 /* GR_NEWLINE  */
  YYSYMBOL_YYACCEPT = 8,                   /* $accept  */
  YYSYMBOL_GR_START = 9,                   /* GR_START  */
  YYSYMBOL_GR_GRAPHINFO = 10,              /* GR_GRAPHINFO  */
  YYSYMBOL_GR_EDGES = 11,                  /* GR_EDGES  */
  YYSYMBOL_GR_EDGE = 12,                   /* GR_EDGE  */
  YYSYMBOL_GR_COMMENTS = 13                /* GR_COMMENTS  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "GR_P", "GR_TW",
  "GR_NUM", "GR_COMMENT", "GR_NEWLINE", "$accept", "GR_START",
  "GR_GRAPHINFO", "GR_EDGES", "GR_EDGE", "GR_COMMENTS", YY_NULLPTR
};
...
#define yyclearin       (yychar = GR_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use GR_error or GR_UNDEF. */
#define YYERRCODE GR_UNDEF
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, Location, graph, result); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, MultiGraph &graph, int &result)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, MultiGraph &graph, int &result)
{
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yykind, yyvaluep, yylocationp, graph, result);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
                 int yyrule, MultiGraph &graph, int &result)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, MultiGraph &graph, int &result)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (graph);
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N), yylsp -= (N))
  ...
  yychar = GR_EMPTY; /* Cause a token to be read.  */
  yylsp[0] = yylloc;
  goto yysetstate;
...
#line 42 "gr_parser.y"
                                                                                                        {}
#line 1286 "gr_parser.cpp"
    break;

  case 3:
#line 44 "gr_parser.y"
                                                                                                           {}
#line 1292 "gr_parser.cpp"
    break;

  case 4:
#line 45 "gr_parser.y"
                                                                                                        {}
#line 1298 "gr_parser.cpp"
    break;

  case 6:
#line 48 "gr_parser.y"
                                                                                                  {graph.addEdgeEndPoints((yyvsp[-1].number),(yyvsp[0].number));}
#line 1304 "gr_parser.cpp"
    break;

  case 7:
#line 50 "gr_parser.y"
                                                                                                  {}
#line 1310 "gr_parser.cpp"
    break;


#line 1314 "gr_parser.cpp"
...
yyerrlab:
  ...
  yytoken = yychar == GR_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, yylsp, graph, result);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, yylsp, graph, result);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
