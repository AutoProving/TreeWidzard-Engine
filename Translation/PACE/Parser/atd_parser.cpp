...
#define YYSTYPE         ATD_STYPE
#define YYLTYPE         ATD_LTYPE
/* Substitute the variable and function names.  */
#define yyparse         atd_parse
#define yylex           atd_lex
#define yyerror         atd_error
#define yydebug         atd_debug
#define yynerrs         atd_nerrs
#define yylval          atd_lval
#define yychar          atd_char
#define yylloc          atd_lloc

/* First part of user prologue.  */
#line 12 "atd_parser.y"
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined ATD_LTYPE_IS_TRIVIAL && ATD_LTYPE_IS_TRIVIAL \
             && defined ATD_STYPE_IS_TRIVIAL && ATD_STYPE_IS_TRIVIAL)))
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == ATD_EMPTY)                                        \
      ...
      {                                                           \
        yyerror (atd, result, YY_("syntax error: cannot back up")); \
        YYERROR;                                                  \
      }                                                           \
  while (0)
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, yylsp, Rule, atd, result); \
} while (0)
