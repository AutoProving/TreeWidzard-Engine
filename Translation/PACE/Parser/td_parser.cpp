...
#line 46 "td_parser.y"
                                                                                                  {}
#line 1304 "td_parser.cpp"
    break;

  case 3:
#line 48 "td_parser.y"
                                                                                                    {td.setNum_vertices((yyvsp[-3].number)); td.setWidth((yyvsp[-2].number)-1); td.setNum_graph_vertices((yyvsp[-1].number)); }
#line 1310 "td_parser.cpp"
    break;

  case 6:
#line 52 "td_parser.y"
                                                                                            {td.setABag(*(yyvsp[0].set_unsigned),(yyvsp[-1].number));}
#line 1316 "td_parser.cpp"
    break;

  case 7:
#line 54 "td_parser.y"
                                                                                         {(yyval.set_unsigned)= new set<unsigned>(*(yyvsp[0].set_unsigned));  (yyval.set_unsigned)->insert((yyvsp[-1].number));}
#line 1322 "td_parser.cpp"
    break;

  case 8:
#line 55 "td_parser.y"
                                                                                   {(yyval.set_unsigned)=new set<unsigned>;}
#line 1328 "td_parser.cpp"
    break;

  case 9:
#line 57 "td_parser.y"
                                                                                                        {}
#line 1334 "td_parser.cpp"
    break;

  case 11:
#line 60 "td_parser.y"
                                                                                          {td.addEdge((yyvsp[-1].number),(yyvsp[0].number));}
#line 1340 "td_parser.cpp"
    break;

  case 12:
#line 63 "td_parser.y"
                                                                                           {}
#line 1346 "td_parser.cpp"
    break;


#line 1350 "td_parser.cpp"
