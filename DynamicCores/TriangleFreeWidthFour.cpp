...
#include "TriangleFreeWidthFour.h"
//TriangleFreeWidthFour

extern "C" {
    DynamicCore * create() {
        return new TriangleFreeWidthFour_DynamicCore;
    }
    DynamicCore * create_int(unsigned param) {
        return new TriangleFreeWidthFour_DynamicCore(param);
    }
}
...
bool TriangleFreeWidthFour_Witness::is_equal(const Witness &rhs) const {
	if (TriangleFreeWidthFour_Witness const *e = dynamic_cast<TriangleFreeWidthFour_Witness const *>(&rhs)) {
		shared_ptr<TriangleFreeWidthFour_Witness const> p = e->shared_from_this();
...
bool TriangleFreeWidthFour_Witness::is_less(const Witness &rhs) const {
	if (TriangleFreeWidthFour_Witness const *e = dynamic_cast<TriangleFreeWidthFour_Witness const *>(&rhs)) {
		shared_ptr<TriangleFreeWidthFour_Witness const> p = e->shared_from_this();
		return getFound(edges) < getFound(p->edges) or (getFound(edges) == getFound(p->edges) and smallestThan(edges, p->edges));
	} else {
...
Witness& TriangleFreeWidthFour_Witness::set_equal(Witness &witness) {
	if (TriangleFreeWidthFour_Witness *e = dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness)) {
		shared_ptr<TriangleFreeWidthFour_Witness> p = e->shared_from_this();
		edges = p->edges;
		return *this;
	} else {
...
void TriangleFreeWidthFour_Witness::print() {
	// cout << "found = " << found << " ";
	// cout<<"E={";
	// for (auto edg : edges)
...
TriangleFreeWidthFour_Witness::~TriangleFreeWidthFour_Witness(){}
...
TriangleFreeWidthFour_DynamicCore::TriangleFreeWidthFour_DynamicCore(unsigned int cliqueSize) {
...
void TriangleFreeWidthFour_DynamicCore::createInitialWitnessSet() {
	shared_ptr<TriangleFreeWidthFour_Witness> witness(new TriangleFreeWidthFour_Witness);
	setFound(witness->edges, false);
	shared_ptr<TriangleFreeWidthFour_WitnessSet> witnessSet(new TriangleFreeWidthFour_WitnessSet);
	setInitialWitnessSet(witnessSet);
	insertIntoInitialWitnessSet(witness);
}

WitnessSetPointer TriangleFreeWidthFour_DynamicCore::intro_v(
...
WitnessSetPointer TriangleFreeWidthFour_DynamicCore::intro_e(
	unsigned i, unsigned j, Bag &b, Witness &witness) {
	if (TriangleFreeWidthFour_Witness *e =
			dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness)) {
		...
		if (getFound(p->edges)) {
			...
			if (isInSet(vertices, i) and isInSet(vertices, j)) {
				...
				if (countNumOfBitsEqualsToOne(vertices) == cliqueSize and
					...
					shared_ptr<TriangleFreeWidthFour_Witness> w( new TriangleFreeWidthFour_Witness);
...
WitnessSetPointer TriangleFreeWidthFour_DynamicCore::forget_v(
	unsigned i, Bag &b, Witness &witness) {
	if (TriangleFreeWidthFour_Witness *e = dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness)) {
		shared_ptr<TriangleFreeWidthFour_Witness> p = e->shared_from_this();
		shared_ptr<TriangleFreeWidthFour_WitnessSet> witnessSet(new TriangleFreeWidthFour_WitnessSet);
...
WitnessSetPointer TriangleFreeWidthFour_DynamicCore::join(
	Bag &b, Witness &witness1, Witness &witness2) {
	if (TriangleFreeWidthFour_Witness *e1 =
			dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness1)) {
		if (TriangleFreeWidthFour_Witness *e2 =
				dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness2)) {
			shared_ptr<TriangleFreeWidthFour_Witness> p1 = e1->shared_from_this();
			shared_ptr<TriangleFreeWidthFour_Witness> p2 = e2->shared_from_this();
			...
			} else if (countNumOfBitsEqualsToOne(vertices) == cliqueSize and sizeSet(aux) == cliqueSize * (cliqueSize - 1) / 2) {
...
bool TriangleFreeWidthFour_DynamicCore::is_final_witness(Witness &witness) {
	if (TriangleFreeWidthFour_Witness *e = dynamic_cast<TriangleFreeWidthFour_Witness *>(&witness)) {
		shared_ptr<TriangleFreeWidthFour_Witness> p = e->shared_from_this();
