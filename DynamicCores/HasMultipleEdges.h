...
public:
    bool is_equal_implementation(const HasMultipleEdges_WitnessPointerConst w) const;
    bool is_less_implementation(const HasMultipleEdges_WitnessPointerConst w) const;
...
class HasMultipleEdges_WitnessSet: public WitnessSetTypeTwo<HasMultipleEdges_WitnessSet>{
...
class HasMultipleEdges_DynamicCore: public DynamicCore{
    ...
    void copyWitness(HasMultipleEdges_WitnessPointer w_input, HasMultipleEdges_WitnessPointer w_output);
    HasMultipleEdges_WitnessPointer createWitness();
    void intro_v_implementation(unsigned i, Bag &b, HasMultipleEdges_WitnessPointerConst w, HasMultipleEdges_WitnessSetPointer witnessSet);
    void forget_v_implementation(unsigned i, Bag &b, HasMultipleEdges_WitnessPointerConst w, HasMultipleEdges_WitnessSetPointer witnessSet);
    void intro_e_implementation(unsigned i,unsigned j, Bag &b, HasMultipleEdges_WitnessPointerConst w, HasMultipleEdges_WitnessSetPointer witnessSet);
    void join_implementation(Bag &b, HasMultipleEdges_WitnessPointerConst w1, HasMultipleEdges_WitnessPointerConst w2, HasMultipleEdges_WitnessSetPointer witnessSet);
    HasMultipleEdges_WitnessSetPointer  clean_implementation(HasMultipleEdges_WitnessSetPointer witnessSet);
    bool is_final_witness_implementation(HasMultipleEdges_WitnessPointerConst w);
public:
    unsigned maxDegree;
    HasMultipleEdges_DynamicCore();
    HasMultipleEdges_DynamicCore(unsigned parameter);
