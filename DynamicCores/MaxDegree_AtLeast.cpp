...
MaxDegree_AtLeast_DynamicCore::MaxDegree_AtLeast_DynamicCore(const parameterType &parameters)
{
...
int MaxDegree_AtLeast_DynamicCore::inv_implementation(Bag &b, MaxDegree_AtLeast_WitnessSetPointer witnessSet)
{
  for (auto witness : (*witnessSet))
  {
    if (MaxDegree_AtLeast_WitnessPointer w = dynamic_pointer_cast<MaxDegree_AtLeast_Witness>(witness))
    ...
    {
      cerr << "ERROR: in MaxDegree_AtLeast_DynamicCore::inv_implementation cast error" << endl;
      exit(20);
    }
  }
  return 0;
...
int MaxDegree_AtLeast_DynamicCore::inv(Bag &b, WitnessSetPointer witnessSet)
{
  if (MaxDegree_AtLeast_WitnessSetPointer e = dynamic_pointer_cast<MaxDegree_AtLeast_WitnessSet>(witnessSet))
  {
  ...
  {
    cerr << "ERROR: in MaxDegree_AtLeast_DynamicCore::inv cast error" << endl;
    exit(20);
  }
}
