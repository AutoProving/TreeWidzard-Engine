...
typedef shared_ptr<CliqueNumberSimpleGraphs_AtLeast_Witness>
	CliqueNumberSimpleGraphs_AtLeast_WitnessPointer;
typedef shared_ptr<CliqueNumberSimpleGraphs_AtLeast_Witness const>
	CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst;
class CliqueNumberSimpleGraphs_AtLeast_Witness
	: public Witness,
	  public enable_shared_from_this<CliqueNumberSimpleGraphs_AtLeast_Witness> {
  public:
	...
	bool is_less_implementation(
		const CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w) const;
	Witness &set_equal_implementation(
...
class CliqueNumberSimpleGraphs_AtLeast_WitnessSet
	: public WitnessSetTypeTwo<CliqueNumberSimpleGraphs_AtLeast_WitnessSet> {
	shared_ptr<WitnessSet> createEmptyWitnessSet() override;
};

typedef shared_ptr<CliqueNumberSimpleGraphs_AtLeast_WitnessSet>
	CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer;

class CliqueNumberSimpleGraphs_AtLeast_DynamicCore : public DynamicCore {
	bool isCompleteClique(
		CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w);
	...
	void intro_v_implementation(
		unsigned i, const Bag &b,
		CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w,
	...
	void forget_v_implementation(
		...
		CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w,
		CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer witnessSet);
	void intro_e_implementation(
		unsigned i, unsigned j, const Bag &b,
		CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w,
		CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer witnessSet);
	void join_implementation(
		const Bag &b, CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w1,
		CliqueNumberSimpleGraphs_AtLeast_WitnessPointerConst w2,
		CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer witnessSet);
	CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer clean_implementation(
		CliqueNumberSimpleGraphs_AtLeast_WitnessSetPointer witnessSet);
